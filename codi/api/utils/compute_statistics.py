...
def micro_averaged_f_score_labels(
    ...
    statistics[f"{label}-clustering"] = {"accuracy": None, "precision": None, "recall": None, "f1_score": f}
...
def f_score(
    ...
    statistics[label] = {"accuracy": acc, "precision": precision, "recall": rec, "f1_score": f}
