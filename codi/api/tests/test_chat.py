...
class TestTime(TestChat):
    ...
    def test_time_is_in_first_bin(self):
        ...
        self.assertEqual(
            self._get_feature(
                Time.extract, self._messages["940033847800766474"], self._messages["939964765420273684"]
            ).val,
            one_hot,
        )
    ...
    def test_time_is_in_second_bin(self):
        ...
        self.assertEqual(
            self._get_feature(
                Time.extract, self._messages["939541995662217246"], self._messages["938733699669848064"]
            ).val,
            one_hot,
        )
    ...
    def test_time_is_in_third_bin(self):
        ...
        self.assertEqual(
            self._get_feature(
                Time.extract, self._messages["939541995662211231"], self._messages["938733699669848234"]
            ).val,
            one_hot,
        )
    ...
    def test_time_is_not_in_bin(self):
        ...
        self.assertEqual(
            self._get_feature(
                Time.extract, self._messages["939541995662938471"], self._messages["938733699669038295"]
            ).val,
            one_hot,
        )
