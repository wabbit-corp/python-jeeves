...
class Framework(TestCase):
    @staticmethod
    def _read_data_from_fixtures(file_path: str) -> dict[str, Any]:
        with open(file_path) as f:
            return json.load(f)

    @staticmethod
    def _get_community_object(data: dict[str, Any]) -> Community:
        """
    ...
    @staticmethod
    def _get_community_members_and_messages(data: dict[str, Any]):
        """
    ...
    def _get_blocks_and_messages(
        ...
        for message in messages_data:
            ...
            if members:
                ...
                links, modified_message = function(members_map, message[blocks_in])
    ...
    def _get_feature(
        ...
        return function(message1, message2, community)
