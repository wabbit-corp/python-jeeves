...
class TestMemberMention(Framework):
    ...
    def test_retrieve_message_with_mention_in_mention(self) -> None:
    ...
    def test_retrieve_message_with_back_to_back_mentions(self) -> None:
