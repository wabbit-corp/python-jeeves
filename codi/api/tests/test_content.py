...
class TestContent(Framework):
    def setUp(self, path: str | None = None, function=None, blocks_in: str = "content"):
...
class TestLink(TestContent):
    def setUp(self, path: str | None = None, function=None, blocks_in=None):
...
class TestAttachment(TestContent):
    def setUp(self, path: str | None = None, function=None, blocks_in: str = "attachments"):
