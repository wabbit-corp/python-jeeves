...
2. **When to Report:** If an issue is serious (e.g. clear harassment, repeated disrespect of the guidelines) or if you have attempted to resolve it without success, you can report it to the project maintainers. The primary contact for Code of Conduct issues is the BDFL (or a designated moderator, if one exists). You may report by contacting **wabbit@wabbit.one**. Include details of the incident, including dates, what was said or done, and any context. Be factual and avoid inflammatory language in your report.
